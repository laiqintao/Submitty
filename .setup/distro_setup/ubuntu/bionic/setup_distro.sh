...
apt install -qqy apt-transport-https ca-certificates curl software-properties-common

# We add this well before we install Java as we can do an apt update before our installations
echo "\n" | add-apt-repository ppa:webupd8team/java
echo oracle-java8-installer shared/accepted-oracle-license-v1-1 select true | sudo /usr/bin/debconf-set-selections
apt-key adv --keyserver hkp://keyserver.ubuntu.com:80 --recv-keys EEA14886

apt install -qqy python python-dev python3 python3-dev libpython3.6
...
apt install -qqy postgresql-10
apt install -qqy apache2 apache2-suexec-custom libapache2-mod-authnz-external libapache2-mod-authz-unixgroup libapache2-mod-wsgi-py3
apt install -qqy php php-cli php-fpm php-curl php-pgsql php-zip
...
# removed: pdftk, hardening-includes
...
# TODO: change "test" to stable at some point in the future once we can install it via stable
