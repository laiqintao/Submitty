...
class Gradeable extends AbstractModel {
    ...
    * that contains filename, file path, and the file size. */
    ...
    protected $total_tagrading_max = 0;

    protected $total_peer_grading_max = 0;
        ...
        if (isset($details['array_gc_id'])) {
            ...
            for ($i = 0; $i < count($details['array_gc_id']); $i++) {
                ...
                if (!$component_for_info->getIsText()) {
                    ...
                    $this->total_tagrading_max += $max_value;
                }
            }
    ...
    public function getTotalTAMax() {
        return $this->total_tagrading_max;
    }
    ...
    public function getGradedData() {
        $data = [
            ...
            "total_ta_max" => $this->getTotalTAMax(),
            "components" => []
        ];
